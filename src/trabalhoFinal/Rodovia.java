...
public class Rodovia {
	...
	private final String siglaCaractere = "BR";
	...
	public String toString() {
		return getSiglaCaractere() + "-" + getSiglaNumero() + "/" + getSiglaEstado() + " - " + getPericulosidade();
	}

	public String getSiglaCaractere() {
		return siglaCaractere;
	}
